...
function QuestionProgress({ current, total, unit, elapsedTime, isStopped = false }) {
  ...
  const formattedElapsedTime = useElapsedTime(elapsedTime, isStopped);
